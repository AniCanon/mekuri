...
enum MekuriFoldShader {
    ...
    /// the layer past the hinge and its sweep stops at the hinge. Every roll
    /// and corner shear flatten as the turn lands, so no roll stands at the
    /// leading edge and a leaf's crease meets the hinge.
    static func make(
        size: CGSize,
        progress: CGFloat,
        ...
        let landing = geometry.landingRadiusScale(progress: progress)
